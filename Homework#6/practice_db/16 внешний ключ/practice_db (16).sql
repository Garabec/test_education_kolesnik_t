...
--
-- Хост: 127.0.0.1
-- Время создания: Окт 30 2016 г., 17:37
...
(1, 'Botswana', 'BW', 465315, 1445348190, 'Christine King', NULL),
(2, 'United States', 'US', 183303, 1290893959, 'Walter Ford', NULL),
(3, 'China', 'CN', 859104, 541575054, 'Walter Crawford', NULL),
(4, 'Portugal', 'PT', 683546, 4000000, 'Steven Ryan', NULL),
(5, 'Japan', 'JP', 174053, 4000000, 'Debra Alvarez', NULL),
(6, 'Canada', 'CA', 945176, 1327777007, 'Phyllis Price', NULL),
(7, 'Germany', 'DE', 821929, 4000000, 'Johnny Lane', NULL),
(8, 'China', 'CN', 416295, 4000000, 'Theresa Lopez', NULL),
(9, 'Ukraine', 'UA', 670720, 4000000, 'Petr Poroshenko', NULL);
