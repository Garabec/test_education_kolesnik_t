...
--
-- Хост: 127.0.0.1
-- Время создания: Окт 30 2016 г., 21:02
...
CREATE TABLE `country` (
  ...
  `premier` varchar(30) DEFAULT NULL
...
INSERT INTO `country` (`id`, `name`, `shot_name`, `land_area`, `population`, `president`, `continent_id`, `premier`) VALUES
(1, 'Botswana', 'BW', 465315, 1445348190, 'Christine King', 1, 'Stephen Lopez'),
(2, 'United States', 'US', 183303, 1290893959, 'Walter Ford', 6, 'Dennis Brown'),
(3, 'China', 'CN', 859104, 541575054, 'Walter Crawford', 5, 'Jimmy Hansen'),
(4, 'Portugal', 'PT', 683546, 4000000, 'Steven Ryan', 1, 'Julie Cole'),
(5, 'Japan', 'JP', 174053, 4000000, 'Debra Alvarez', 6, 'Clarence Butler'),
(6, 'Canada', 'CA', 945176, 1327777007, 'Phyllis Price', 5, 'Nicole Andrews'),
(7, 'Germany', 'DE', 821929, 4000000, 'Johnny Lane', 4, 'Jeffrey Gray'),
(9, 'Ukraine', 'UA', 670720, 4000000, 'Petr Poroshenko', 2, 'George Stone');
