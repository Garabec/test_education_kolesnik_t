...
--
-- Хост: 127.0.0.1
-- Время создания: Окт 30 2016 г., 16:04
...
(4, 'Portugal', 'PT', 683546, 1067346158, 'Eurasia', 'Steven Ryan'),
(5, 'Japan', 'JP', 174053, 759776200, 'Eurasia', 'Debra Alvarez'),
(6, 'Canada', 'CA', 945176, 1327777007, 'North America', 'Phyllis Price'),
(7, 'Germany', 'DE', 821929, 582879595, 'Eurasia', 'Johnny Lane'),
(8, 'China', 'CN', 416295, 286933813, 'Eurasia', 'Theresa Lopez'),
(9, 'Ukraine', 'UA', 670720, 755267782, 'Eurasia', 'Victor Cole'),
(10, 'China', 'CN', 685682, 797694635, 'Eurasia', 'Bobby Hunter');
